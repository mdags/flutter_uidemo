        ...
        child:StaggeredGridView.count(
          ...
          children: <Widget>[
            Padding(
              ...
              child: mychart1Items("Aylık Satış","421.3M","+12.9% hedef"),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: myCircularItems("Çeyrek Bazlı","68.7M"),
            ),
            Padding(
              padding: const EdgeInsets.only(right:8.0),
              child: myTextItems("Harcama","48.6M"),
            ),
            Padding(
              padding: const EdgeInsets.only(right:8.0),
              child: myTextItems("Satın Alma","25.5M"),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: mychart2Items("Giderler","0.9M",""),
            ),
